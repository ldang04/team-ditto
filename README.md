...
#### Here is an example of CI catching an error through Unit tests (Testing #32/PR #76):
...
### And here it is after the issues were resolved (Testing #32/PR #76):
...
![sc of ci w/ good stylce and static](./images/ci_good_stat_style_12_12.png)
...
![sc of style checker report](./images/checkstyle_report_12-12.png)
...
![branch coverage report](./images/branchcov_report_12_12.png)
